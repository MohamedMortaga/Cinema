...
export default function Horror() {
  ...
  async function Movies() {
    const response = await axios.get(
      "https://www.omdbapi.com/?apikey=df3dd93f&s=horror"
    );
  ...
  return (
    <>
      <div className="mt-5 p-5 bg-dark text-center">
        <h1
          className={`text-white mb-4  ${style.mm} d-flex justify-content-center align-items-center m-auto p-1  w-25 border rounded-5`}
        >
          Horror Movies
        </h1>
