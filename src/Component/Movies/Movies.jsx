...
export default function Movie() {
    ...
    const x = await axios.get('https://www.omdbapi.com/?apikey=df3dd93f&s=action');
    console.log('Movies:', x.data.Search);
  ...
  return <>
   <div className="mt-5 p-5 bg-dark text-center">
        <h1 className={`text-white mb-4  ${style.mm} d-flex justify-content-center align-items-center m-auto p-1  w-25 border rounded-5`}>Action Movies</h1>
